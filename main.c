...
/*   Updated: 2025/07/20 12:31:57 by zouazrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		// 	free(ptr);
// 		// }
// 		printf("\033[36m[value : \033[0m\033[33m%s\033[0m\033[36m
// ]		   [type : \033[0m\033[32m%s\033[0m\033[36m]\033[0m====%d\n",
...
// 					type_to_str(red->type), red->quoted);
// 				red = red->next;
// 			}
// 		}
// 		printf("\n");
